// 12.	Implement Circular Linked List using templates. Include functions for insertion, deletion and search of a number, reverse the list.
#include <iostream>
#include <iomanip>
using namespace std;
...
public:
    ...
    void operator +(CirSinglyLinkedList &l)
    {
...
int main()
{
    CirSinglyLinkedList<int>* list_1 = new CirSinglyLinkedList<int>();
    CirSinglyLinkedList<int>* list_2 = new CirSinglyLinkedList<int>();
    CirSinglyLinkedList<int>* A = list_1;
    int list_choice = 1; 
    char flag = 'y';
    int choice;
    //menu
    do{
        ...
        cout<<"1. Search \n"
            ...
            <<"8. Display Count\n"
            <<"9. Change List\n"
            <<"10. Concatenate (1 = 1 + 2)\n"
            <<"11. Concatenate (2 = 2 + 1)\n"
            <<"12. Exit\n";
        //getting user input
