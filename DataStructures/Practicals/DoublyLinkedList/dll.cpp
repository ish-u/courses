// 11.	Implement Doubly Linked List using templates. Include functions for insertion, deletion and search of a number, reverse the list.
#include <iostream>
#include <iomanip>
using namespace std;
...
public:
    ...
    void operator +(DoublyLinkedList &l)
    {
        if(this->totalNodes > 0 && l.totalNodes > 0)
        {
            ...
            while(l.temp != 0)
            {
                newNode = new Node<T>(l.temp->data,0,0);
                this->totalNodes++;
                this->temp->nextNode = newNode;
                newNode->prevNode = this->temp;
...
int main()
{
    DoublyLinkedList<int>* list_1 = new DoublyLinkedList<int>();
    DoublyLinkedList<int>* list_2 = new DoublyLinkedList<int>();
    DoublyLinkedList<int>* A = list_1;
    int list_choice = 1; 
    char flag = 'y';
    int choice;
    //menu
